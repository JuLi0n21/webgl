const { mat2, mat2d, mat4, mat3, quat, quat2, vec2, vec3, vec4 } = glMatrix; //to help dependcy issues?
...
var InitDemo = function () {
    ...
    gl.vertexAttribPointer(
        ...
        gl.FLASE, //If data is normalised
        6 * Float32Array.BYTES_PER_ELEMENT,// Size of an individual vertex
        3 * Float32Array.BYTES_PER_ELEMENT //offset aform the befinning of a single vertex to this attribute
    );
    ...
    var xRoationMatrix = new Float32Array(16);
    var yRoationMatrix = new Float32Array(16);
    ...
    var angle = 0;
    var loop = function () {
        angle = performance.now() / 700 / 6 * 2 * Math.PI; 
        mat4.rotate(xRoationMatrix, identityMatrix, angle, [0, 1, 0]);
        mat4.rotate(yRoationMatrix, identityMatrix, angle / 6, [1, 0, 0]);
        mat4.mul(worldMatrix, xRoationMatrix, yRoationMatrix);
